  ...
  var Engine = (window.Engine = {
    ...
    init: function (options) {
      ...
      $("<span>")
        ...
        .text(_("github."))
        .click(function () {
          window.open("https://github.com/Williamlifetime/adarkroom");
        })
        .appendTo(menu);
      ...
      if ($SM.get("config.hyperMode", true)) {
        Engine.triggerHyperMode($SM.get("config.hyperSpeed", true));
      }
    ...
    confirmHyperMode: function () {
      if (!Engine.options.doubleTime) {
        Events.startEvent({
          ...
          scenes: {
            start: {
              text: [_("how many multiples of speed do you want to activate?")],
              buttons: {
                "2x": {
                  text: _("2x"),
                  nextScene: "end",
                  onChoose: () => Engine.triggerHyperMode(2),
                },
                "5x": {
                  text: _("5x"),
                  nextScene: "end",
                  onChoose: () => Engine.triggerHyperMode(5),
                },
                "10x": {
                  text: _("10x"),
                  nextScene: "end",
                  onChoose: () => Engine.triggerHyperMode(10),
                },
                no: {
                  text: _("no"),
                  nextScene: "end",
    ...
    triggerHyperMode: function (multiples) {
      Engine.options.doubleTime = !Engine.options.doubleTime;
      if (Engine.options.doubleTime) {
        Engine.options.hyperSpeed = multiples;
        $(".hyper").text(_("classic."));
      } else {
        Engine.options.hyperSpeed = 1;
        $(".hyper").text(_("hyper."));
      }
      $SM.set("config.hyperMode", Engine.options.doubleTime, false);
      $SM.set("config.hyperSpeed", Engine.options.hyperSpeed, false);
    },
    ...
    travelTo: function (module) {
      ...
      if (
        ...
        Engine.activeModule == Fabricator
      ) {
